...
declare module "react-native-cached-image" {
  namespace CachedImage {
    interface Image {
      /**
       * a function that returns a component, used to override the underlying Image component.
       */
  ...
  export class CachedImage extends React.Component<
    ReactNative.ImageProps & CachedImage.Image
  > {}
  export class ImageCacheProvider extends React.Component<
